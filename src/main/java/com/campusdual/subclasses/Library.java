...
public class Library {
    public static void main(String[] args) {
        ...
        Book book = new Book("The Martian Chronicles", "Ray Bradbury", "1950-05-04", "987453647365");
        Magazine magazine = new Magazine("Historia National Geographic", "Josep Maria Casals", "2024-05", 2045);
